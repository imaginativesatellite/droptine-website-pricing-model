    ...
    <div>
      ...
      {users.map((u) => (
        <div className="card" key={u.id} style={{ marginBottom: 12 }}>
          ...
          <EditUserForm
            user={{ id: u.id, name: u.name, email: u.email, phone: u.phone, role: u.role, clientPortalEnabled: u.clientPortalEnabled, quotesDefaultPrivate: u.quotesDefaultPrivate }}
